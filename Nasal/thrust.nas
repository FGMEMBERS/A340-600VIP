...
var toga_lk = func {
	...
	if  ((state1 =="AFLOOR") and (state2 == "AFLOOR") and (state3 == "AFLOOR") and (state4 == "AFLOOR") and (spd > 128)) {
		setprop("/controls/engines/engine[0]/throttle",0.99);
		setprop("/controls/engines/engine[1]/throttle",0.99);
		setprop("/controls/engines/engine[2]/throttle",0.99);
		setprop("/controls/engines/engine[3]/throttle",0.99);
